...
/**
 * JBehave runner for regression test stories.
 */
@Slf4j
public class RegressionStoryRunner extends JUnitStories {
    ...
    public InjectableStepsFactory stepsFactory() {
        ...
        log.info("RegressionStoryRunner initialized with {} step bean(s)", stepBeans.size());
        return new InstanceStepsFactory(configuration(), stepBeans.toArray());
    }

    @Override
    protected List<String> storyPaths() {
        return List.of("com/bookstore/jbehave/stories/regression_tests.story");
    }
}
